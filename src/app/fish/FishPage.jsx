...
export default function FishPage({status}) {
    ...
    return (
        <div className="m-10 p-8">
            <div className="flex w-full justify-between">
                <h1 className="text-2xl font-bold mb-4">ফিশিং</h1>

                <div>
                    <Link href="/fish" className="text-2xl font-bold mb-4 text-[#d4a017] hover:text-orange-400">
                        আরও খেলা দেখুন ...
                    </Link>
